...
par(mfrow = c(2,2))
plot(hpc2$DateTime1, 
      as.numeric(as.character(hpc2$Global_active_power)), 
      type = "l", lwd = 1, 
      xlab = "", ylab = "Global Active Power", cex.lab = 0.4, cex.axis = 0.6)
plot(hpc2$DateTime1, 
      as.numeric(as.character(hpc2$Voltage)), 
      type = "l", lwd = 1, 
      xlab = "datetime", ylab = "Voltage", cex.lab = 0.4, cex.axis = 0.6)
plot(hpc2$DateTime1, as.numeric(as.character(hpc2$Sub_metering_1)), 
      type = "l", col = "black", 
      xlab = "", ylab = "Energy sub metering", cex.lab = 0.4, cex.axis = 0.6,)
...
plot(hpc2$DateTime1, 
      as.numeric(as.character(hpc2$Global_reactive_power)), 
      type = "l", lwd = 1, 
      xlab = "", ylab = "Global_reactive_Power", cex.lab = 0.4, cex.axis = 0.6,)
